...
from Ui_OutSampleInvoiceView import Ui_OutSampleInvoiceView
from Ui_Payments_Logic import Ui_Payments_Logic


class Ui_OutSampleInvoiceView_Logic(object):
    def __init__(self, sqlconnector, filemanager, invoice_id):
        ...
        self.ui = Ui_OutSampleInvoiceView()
    ...
    def initialize(self):
        ...
        self.fetchOutSampleInvoice()

    def openPaymentsWindow(self):
        Ui_Payments_Logic(self.sqlconnector, self.invoice_id).showUi()
        self.setPaid()

    def fetchOutSampleInvoice(self):
        invoice_data = self.database_operations.fetchSamplesOutInvoice(self.invoice_id)
