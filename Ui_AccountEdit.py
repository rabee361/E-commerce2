...
class Ui_AccountEdit(object):
    def setupUi(self, AccountEdit):
        ...
        self.gridLayout_2.addWidget(self.details_input, 2, 1, 1, 2)
...
"    }")
        ...
        self.select_parent_account_btn.setMaximumSize(QtCore.QSize(75, 16777215))
...
"    }")
        ...
        self.select_final_account_btn.setMinimumSize(QtCore.QSize(0, 0))
        self.select_final_account_btn.setMaximumSize(QtCore.QSize(75, 16777215))
...
"    }")
    ...
    def retranslateUi(self, AccountEdit):
        ...
        self.select_parent_account_btn.setText(_translate("AccountEdit", "...اختيار"))
        self.label_5.setText(_translate("AccountEdit", "الحساب الختامي:"))
        self.select_final_account_btn.setText(_translate("AccountEdit", "...اختيار"))
        self.label_3.setText(_translate("AccountEdit", "تاريخ الإنشاء"))
        self.groupBox_4.setTitle(_translate("AccountEdit", "القائمة المالية"))
        self.select_financial_statement_btn.setText(_translate("AccountEdit", "...اختيار"))
