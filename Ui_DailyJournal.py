...
class Ui_DailyJournal(object):
    def setupUi(self, DailyJournal):
        ...
        self.gridLayout_7.addWidget(self.calculate_btn, 3, 4, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.groupBox_6, 0, 3, 4, 1)
        ...
        self.gridLayout_7.addWidget(self.from_date_input, 0, 1, 1, 1)
        self.to_date_input = QtWidgets.QDateEdit(self.groupBox)
        self.to_date_input.setObjectName("to_date_input")
        self.gridLayout_7.addWidget(self.to_date_input, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.groupBox_7, 0, 2, 2, 1)
        ...
        self.gridLayout_7.addWidget(self.groupBox_5, 2, 2, 2, 1)
