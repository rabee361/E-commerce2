from Ui_WarehouseMovement import Ui_WarehouseMovement
...
class Ui_WarehouseMovement_Logic(QDialog):
    def __init__(self, sql_connector=''):
        super().__init__()
        self.sql_connector = sql_connector
        if self.sql_connector:
            self.database_operations = DatabaseOperations(sql_connector)
        self.ui = Ui_WarehouseMovement()
        self.filemanager = ''
        self.current_user = ''
    ...
    def calculate(self):
        ...
        if warehouse_id:
            ...
            for material_move in warehouse_moves:
                ...
                quantity = float(material_move['quantity'])
