...
"    }")
        ...
        self.gridLayout_6.addWidget(self.from_date_input, 1, 1, 1, 1)
        self.to_date_input = QtWidgets.QDateEdit(self.groupBox_8)
        self.to_date_input.setObjectName("to_date_input")
        self.gridLayout_6.addWidget(self.to_date_input, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Trial_Balance):
        ...
        self.select_account_btn.setText(_translate("Trial_Balance", "🔎"))
